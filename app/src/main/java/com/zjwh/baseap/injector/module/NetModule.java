...
import com.zjwh.baseap.injector.PetQual;
import com.zjwh.baseap.model.net.ApiConfig;
import com.zjwh.baseap.model.net.api.PetShowApi;
import com.zjwh.baseap.model.net.converter.FastJsonConverterFactory;
import com.zjwh.baseap.tools.NetworkUtils;
...
//        builder.addInterceptor(apikey);
    ...
    @Singleton
    @Provides
    PetShowApi provideWaterService(@PetQual Retrofit retrofit){
        return retrofit.create(PetShowApi.class);
    }
